namespace Masasamjant.Claiming
{
    ...
    public interface IClaimingService
    {
        ...
        Task<ClaimDescriptor> TryClaimAsync(IClaimable claimable, string ownerIdentifier);
        ...
        /// <param name="ownerIdentifier">The unique identifier or claim owner.</param>
        /// <returns>A <see cref="IClaimDescriptor"/> to descibe the result.</returns>
        Task<ClaimDescriptor> TryClaimAsync(ClaimKey claimKey, string ownerIdentifier);
        ...
        Task<ClaimDescriptor> GetClaimAsync(ClaimKey claimKey, string ownerIdentifier);
        ...
        Task<IEnumerable<ClaimDescriptor>> GetClaimsAsync(string ownerIdentifier, bool onlyOwnedClaims);
        ...
        Task<bool> ReleaseClaimAsync(ClaimDescriptor claimDescriptor);
    }
}
